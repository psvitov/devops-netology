...
Создадим простой манифест Ansible с указанием хоста, но в случае распространения на несколько серверов, лучше использовать отдельный файл hosts и доработать манифест, разделив задачи на роли:
