...
| :-------: | :-------: | :-------: | :-------: | :-------: | :-------: |
| SSL/TLS-терминация   | Текст    | Текст    | Текст    | Текст    | Текст    |
| Аутентификация   | Текст    | Текст    | Текст    | Текст    | Текст    |
| Логгирование   | Текст    | Текст    | Текст    | Текст    | Текст    |
| Отслеживание инъекции   | Текст    | Текст    | Текст    | Текст    | Текст    |
| Балансировка нагрузки   | Текст    | Текст    | Текст    | Текст    | Текст    |
| Интеграция обнаружения сервисов   | Текст    | Текст    | Текст    | Текст    | Текст    |
| Маршрутизация   | Текст    | Текст    | Текст    | Текст    | Текст    |
| Авторизация   | Текст    | Текст    | Текст    | Текст    | Текст    |
| Ограничение скорости и очередь   | Текст    | Текст    | Текст    | Текст    | Текст    |
| Манипулирование запросом/ответом   | Текст    | Текст    | Текст    | Текст    | Текст    |
